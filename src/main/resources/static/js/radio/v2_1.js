...
var select = '<div style="color: '+g_text_color+';" onclick="return rad_show_stations();" id="rad_select" align="left"><div id="rad_stationname">' + '<img src="https://eda-studio.ru/stiles/img/logo.png" align="" id=""><span id="rad_select_main_text">' + rad_stations[0][1] + '</span></div>';
	...
	for (var i=0; i<rad_stations.length; i++){
		...
		if (rad_stations[i][2]!=undefined){
	        select += '<img src="" class="" align="absmiddle">';
	    }else{
	    	select += '<img src="https://radiobells.com/stations/noradio_70.jpg" class="" align="absmiddle">';
	    }
...
var block_logo = '<div id="rad_block_logo" align="center"><a><img src="'+rad_plogo+'" border="0" id="rad_logo" ></a></div>';
...
if (g_rad_player_width<=430){
    ...
    document.getElementById('rad_player').style.height = '68px';
